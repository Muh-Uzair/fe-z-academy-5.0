...
const courseToBuy: Course = {
    ...
    description: "Learn MERN stack from scratch and build real-world apps. This comprehensive course will take you from a beginner to an advanced developer. You will learn MongoDB, Express, React, and Node.js. Build RESTful APIs, manage state with Redux, and deploy your applications to the cloud.",
    ...
    return (
        <div className="container mx-auto py-10 px-4 space-y-12 max-w-6xl">
                            ...
                            <div className="p-6 md:p-8 space-y-6">
                                <div className="flex flex-col md:flex-row justify-between items-start gap-4">
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-muted-foreground font-medium">By {courseToBuy.instructor} &bull; {courseToBuy.category}</p>
                                    </div>
                                    <Badge variant="secondary" className="capitalize text-sm px-3 py-1 shrink-0">
                                        {courseToBuy.level}
                                    </Badge>
                                </div>
                                ...
                                <div className="flex flex-wrap gap-x-6 gap-y-3 text-sm text-muted-foreground bg-muted/30 p-4 rounded-xl border">
                                    <div className="flex items-center gap-1.5 text-yellow-500 font-medium">
                                        ...
                                        <span className="text-muted-foreground font-normal">({courseToBuy.totalReviews} reviews)</span>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-1.5">
                                        ...
                                        <span>{Math.floor(courseToBuy.totalDurationInMinutes / 60)}h {courseToBuy.totalDurationInMinutes % 60}m</span>
                                    </div>
                                </div>
                ...
                <div className="lg:col-span-2">
                    <Card className="sticky top-6 border-2 shadow-lg">
                        <CardHeader className="bg-muted/30 border-b pb-6">
                            ...
                            <CardDescription>Complete your purchase to start learning.</CardDescription>
                        </CardHeader>
                        <CardContent className="pt-6">
                            ...
                            <Form {...form}>
                                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormControl>
                                                    <Input placeholder="1234567890123456" {...field} maxLength={16} className="h-11 font-mono" />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input placeholder="MM/YY" {...field} maxLength={5} className="h-11 font-mono" />
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
                                            )}
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input placeholder="123" {...field} maxLength={4} className="h-11 font-mono" />
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
                                            )}
                                    ...
                                    <Button type="submit" className="w-full h-12 text-md mt-6" size="lg">
                            ...
                            <div className="mt-6 text-center">
                                <p className="text-xs text-muted-foreground bg-muted/50 p-3 rounded-lg border border-dashed">
                                    This is a dummy checkout page. No real payment will be processed. All data will be logged to the console.
                                </p>
                            </div>
                        </CardContent>
                    </Card>
            ...
            <div className="space-y-8">
                <div>
                    <h2 className="text-2xl font-bold tracking-tight">Similar Courses You Might Like</h2>
                    <p className="text-muted-foreground mt-1">Explore other highly rated courses in the same category.</p>
                </div>
                ...
                <DialogContent className="sm:max-w-md">
                    <DialogHeader className="flex flex-col items-center gap-2">
                        ...
                        <DialogDescription className="text-center text-base">
                            Your dummy payment has been submitted successfully! Check your console logs for the transaction details.
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter >
